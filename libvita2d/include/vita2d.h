...
int vita2d_font_draw_text_dropshadow(vita2d_font *font, int x, int y, unsigned int color, unsigned int size, const char *text, int dropshadowX, int dropshadowY, unsigned int dropshadowColor);
